...
module.exports = function (buildOptions) {
    ...
    return gulp.task('replace:environment', function (cb) {
        var file = 'environment.json';
        var isRelease = false;
        var isProductionEnvironment = false;
        var logLevels = tarsConfig.catberry.dev.levelsServer;
        if (buildOptions.production) {
            isRelease = true;
            isProductionEnvironment = true;
            logLevels = tarsConfig.catberry.prod.levelsServer;
        }
