...
ErrorMessage.prototype.render = function () {
  var a = this.$context.attributes, labelKey = a['label-key'], mess = a['text-key'] || 'ERROR_MESSAGE', elClass = a['el-class'], butClose = a['button-close'], lp = lh.getLocalizationProvider(this.$context), curLocale = lh.getCurrentLocale(this.$context);
  var e = {
