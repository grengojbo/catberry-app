...
var lh = require('../../../lib/helpers/l10nHelper'), bh = require('../../../lib/helpers/browserHelper');
/*
...
Button.prototype.render = function () {
  var a = this.$context.attributes, label = a.label, href = a.href, butClass = a['button-class'], butStyle = a['button-input'],
    // input/button
    placeholderKey = a['placeholder-key'], typeBut = a.type, lp = lh.getLocalizationProvider(this.$context), curLocale = lh.getCurrentLocale(this.$context);
  var b = {
    name: a.name,
    label: label,
...
Button.prototype.disable = function () {
  var el = this.$context.element.querySelector('input');
  el.disabled = true;
  bh.addClass(el, 'disabled');  // console.log('------------------- submit disable ------------');
                                // console.log(el);
